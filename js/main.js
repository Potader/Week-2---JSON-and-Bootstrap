// JSON data for favourite singers
...
// Pulls in table as variable singerList, and parses JSON data into workable JavaScript object
let singerList = document.getElementById("singer-list");
const singers = JSON.parse(favouriteSingers);

// This accepts each key:value pair in the JSON data, creates a new table row,
// then puts the values from the pair into the new cells created
